...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="display-4">Du Photoshop tous les jours</h1>
            ...
            <h1 class="display-4">Un choix de carrière difficile</h1>
            <p class="authorView--page--text">
            ...
            <blockquote class="blockquote authorView--page--blockquote">
                <p class="mb-0">Mieux vaut voir quelque chose une fois que d'en entendre parler mille fois.</p>
                <footer class="blockquote-footer authorView--page--blockquote"><cite title="Source Title">Proverbe Touarege</cite></footer>
            </blockquote>
        </div>
    </div>
</div>
