<?php $titleSite = 'Le graphiste'; ?>
<?php ob_start(); ?>
<div class="banner-authorView jumbotron">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="my-4 banner-authorView--text">JEAN FORTEROCHE</h1>
                <h2 class="my-4 banner-authorView--text">L'AUTEUR</h2>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="display-4">D'abord un homme de science</h1>
            <p class="authorView--page--text">Nam facilisis enim in condimentum aliquet. Vivamus fringilla ex a consequat ullamcorper. Phasellus mattis, ligula nec blandit semper, leo ante ultrices augue, eget semper quam mauris ut tellus.
                Integer quis ultrices tortor. Morbi fermentum facilisis dolor, et ultricies dolor semper sit amet. Nam vulputate laoreet arcu, vitae efficitur neque aliquam a.
                Suspendisse placerat tellus sed magna sollicitudin maximus at in tortor. Etiam in tempor elit. Nullam at consectetur lectus.</p>
            <p class="authorView--page--text">
                Maecenas lacinia nulla et massa egestas sollicitudin. Curabitur commodo, mauris pulvinar feugiat tincidunt, sem dolor suscipit orci, sit amet porta ligula massa a neque. Duis ac ipsum ut justo commodo viverra in eu mi.
            ...
            <h1 class="display-4">Un changement de vie</h1>
            <p class="authorView--page--text">
                Pellentesque lacus ligula, dignissim at venenatis ut, tempor ac libero. Nam est purus, volutpat in est eget, placerat malesuada ante. Duis eros ligula, pulvinar et sapien in, porta lacinia est.
                Phasellus commodo mauris eu felis sagittis tincidunt. Aenean egestas lacinia tellus, quis sodales odio pretium eu. Ut quis fermentum purus. Phasellus cursus, turpis vitae fringilla tristique, ipsum purus luctus mi, sollicitudin mollis magna nisi sed ante.
                Vestibulum vulputate ipsum et gravida condimentum. Etiam erat nisl, feugiat id tincidunt ac, scelerisque sed erat. Vestibulum ultricies sem non urna suscipit tempus. Pellentesque rhoncus nisl id libero rhoncus faucibus. Nam sed ultricies libero. Praesent interdum nisi non velit vehicula dapibus.
                Donec gravida turpis sit amet nibh consequat auctor. </p>
            <p class="authorView--page--text">
            ...
            <h1 class="display-4 authorView--page--title">Enfin la paix</h1>
            <p class="authorView--page--text">Etiam tristique ligula ex, ut viverra turpis laoreet sit amet. Suspendisse tellus odio, suscipit a accumsan nec, blandit eu nisl. Nunc in mattis tellus. Ut imperdiet arcu a aliquam interdum. Mauris nec ex tellus. Morbi porta lacus ac convallis pharetra. Donec eleifend eu dui ac vestibulum. Sed at nibh vel mi efficitur viverra.
                Sed malesuada mauris nec iaculis dictum. Curabitur viverra enim nibh, sed tristique ipsum eleifend eu. Morbi enim sem, egestas id massa sed, commodo convallis lorem. Integer consectetur lacus vel nisl semper blandit. Duis vulputate ullamcorper libero ac placerat. Phasellus at vehicula quam. Integer libero quam, pellentesque in eros id, viverra rhoncus elit.
                Nam placerat euismod pretium. </p>
            <blockquote class="blockquote authorView--page--blockquote">
                <p class="mb-0">Je ne regrette pas les choix que j'ai fait car ce sont eux qui m'ont amené où je suis.</p>
                <footer class="blockquote-footer authorView--page--blockquote">Extrait paru dans <cite title="Source Title">Le Monde</cite> édition 19 mars 2019</footer>
            </blockquote>
        </div>
    </div>
</div>
