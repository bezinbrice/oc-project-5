...
class CommentManager extends Manager
{
    ...
    {
        $db = $this->dbConnect();
        $comments = $db->prepare('SELECT comment_id, author, comment, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin%ss\') AS comment_date_fr, report FROM comments WHERE post_id = :postId ORDER BY comment_date DESC');
